...
|---|---|---|
| [**MolPredict Inference API**](https://github.com/anantshri1/homo-lumo-gat) · [API Service](https://homo-lumo-gat.fly.dev/docs)| A GATv2 inference API service for predicting HOMO-LUMO gaps of organic molecules via an MCP server; also containerized with CUDA-enabled Docker. | `PyTorch Geometric`, `FastAPI`, `Docker`, `RDKit`, `MCP` |
